  ...
  return (
      ...
      <div className="footer-container">
        ...
        <div className="footer-section">
          ...
          <div className="nav-links">
            ...
            <a href="https://www.x.com/" target="_blank" className="nav-link-footerDark">
              Twitter - X
            </a>
          </div>
        </div>
    ...
    <div className="terms-container">
        <div className="terms-grid">
          <div className="rightsDark">©2024 AVGI Group. All rights reserved</div>
          <div className="rights-container">
            ...
            <a
              className="developedDark"
              href="https://webelopers.io/#home"
              target="_blank"
            >
              Developed by <a className="gradient-developedDark">WEBELOPERS</a>
            </a>
          </div>
        </div>
      </div>
